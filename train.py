...
@click.option('--seg_weight',    help='Segmentation Loss weight.', metavar='FLOAT', type=click.FloatRange(min=0), default=1., required=False, show_default=True)
@click.option('--hist_weight',    help='Histogram Color Loss weight.', metavar='FLOAT', type=click.FloatRange(min=0), default=30., required=False, show_default=True)
@click.option('--hist_type',    help='Histogram Color Loss type.', metavar='STR', type=click.Choice(['per_label', 'whole']), required=False, default='per_label')
@click.option('--hist_adv',    help='Adversarial Loss weight along with Histogram Color Loss.', metavar='FLOAT', type=click.FloatRange(min=0), default=1., required=False, show_default=True)
def main(**kwargs):
    """Train a GAN using the techniques described in the paper
    "Alias-Free Generative Adversarial Networks".
    ...
    c.loss_kwargs.hist_weight = opts.hist_weight
    c.loss_kwargs.hist_adv = opts.hist_adv
    c.loss_kwargs.hist_type = opts.hist_type
